...
--run_once('xrandr --newmode  "1920x1200_60.00"  193.25  1920 2056 2256 2592  1200 1203 1209 1245 -hsync +vsync')
--run_once('xrandr --addmode eDP-1 "1920x1200_60.00"')
--run_once("xrandr --output eDP-1 --mode 1920x1200_60.00")
run_once("xrandr --output DP-2-1 --rotate right --mode 1920x1080 --left-of eDP-1")
...
if beautiful.wallpaper then
   for s = 1, screen.count() do
      ...
      if s < 2 then
         gears.wallpaper.maximized(beautiful.wallpaper, s, true)
         --gears.wallpaper.maximized("~/.config/awesome/themes/holo/think_correctly.jpg", s, true)
      else
         gears.wallpaper.maximized(beautiful.wallpaper, s, true)
         --gears.wallpaper.maximized("~/.config/awesome/themes/holo/think_correctly.jpg", s, true)
      end
...
globalkeys = awful.util.table.join(
    ...
    -- Tag browsing
    --awful.key({        }, "F3"  ,   awful.tag.viewonly(tags()[3])),
    awful.key({        }, "F2"  ,   awful.tag.viewprev       ),
    awful.key({        }, "F1"  ,   awful.tag.viewnext       ),
...
awful.rules.rules = {
    ...
    -- tags[x][y] means tag(x) in screen(y)
    { rule = { class = "chromium" },
